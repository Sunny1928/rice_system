    ...
    <div  style="position:relative;width: 812px;background-color: antiquewhite; overflow: hidden;">
      ...
      <div style="margin-top: 5px;width:100%;">
        <div style="display: flex; border-top: 2px solid #000; border-bottom: 2px solid #000; ">
          ...
          <p style="width:7%;text-align:end;margin:1px 3px;">數量</p>
          <p style="width:7%;text-align:end;margin:1px 3px;">包數</p>
          <p style="width:9%;text-align:end;margin:1px 3px;">總數量</p>
        ...
        <div style="min-height:240px;">
          <div style="display: flex;" v-for="(item, index) in trades">
            ...
            <p style="width:7%; text-align: end;margin:1px 3px;">{{numWithComma(item.amount)}}</p>
            <p style="width:7%; text-align: end;margin:1px 3px;">{{numWithComma(item.package)}}</p>
            <p style="width:9%; text-align: end;margin:1px 3px;">{{numWithComma(item.totalNumber)}}</p>
            <p style="width:5%;  text-align: end;margin:1px 3px;">{{item.sellUint}}</p>
            <p style="width:8%; text-align: end;margin:1px 3px;">{{numWithComma(item.uintPrice)}}</p>
            <p style="width:12%; text-align: end;margin:1px 3px;">{{numWithComma(item.aTradePrice)}}</p>
